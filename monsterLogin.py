...
time.sleep(2)
driver.find_element(by=AppiumBy.XPATH, value="//android.widget.EditText[@content-desc='eposta']").send_keys("email")
driver.find_element(by=AppiumBy.XPATH, value="//android.widget.EditText[@content-desc='password']").send_keys("password")
time.sleep(1)
